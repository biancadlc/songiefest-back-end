...
# each user can have only one profile. if User deleted, profile destroyed too
# ForeignKey is used for one-to-many relationships, need to use OntToOneField for one-to-one
...
# ==========     COMMENT     ========== #
# links comment w/ the post(music stat) & the user
